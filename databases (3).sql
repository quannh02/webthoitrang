...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2016 at 08:39 PM
...
CREATE TABLE `orders` (
  ...
  `ord_phone` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `product` (`pro_id`, `c_id`, `p_id`, `pro_name`, `pro_images`, `pro_description`, `pro_code`, `pro_price`, `pro_color`, `pro_sizeM`, `pro_sizeL`, `pro_sizeS`, `created_at`, `updated_at`) VALUES
(2, 1, 0, 'Áo sơ mi nam tay dài thời trang', 'somi4.jpg', '', 'SM2', 185000, 'xanh lam1', 1, 1, 2, '2016-06-06 19:40:03', '0000-00-00 00:00:00'),
...
(12, 'nguyễn văn đại', '$2y$10$PAGes5APb1SaRtcIo73OVOfkLQk1mpF6Cy5uDlcJ4q6M2wg7.lTtG', '', '', 'a@jmail', '', 1, 'member', 'HA4tEBHDrG7Pt9ElBZJ6ILH5m6wxsNEOddQJadYq70ZzmyDPNx3ddxmvgiWc', '2016-06-08 07:42:12', '2016-06-08 00:42:12');
...
--
ALTER TABLE `orders`
  MODIFY `ord_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
